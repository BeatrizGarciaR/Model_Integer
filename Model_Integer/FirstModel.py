...
sheet = book.add_sheet('Tesis_FirstModel_210924', cell_overwrite_ok=True)
    ...
    for jconj in range(len(tamaños_L)):
        for sconj in range(len(tamaños_S)):
            ...
            #for rep in range(repeticiones):
                ...
                with open('data_FirstModel_210924_'+str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                f = open ('Resultados_Prueba_FirstModel_210924_'
                              +str(len(I))+str('_')
                              +str(len(L))+str('_')
                              #+str(len(K))+str('_')
                              #+str(len(N))+str('_')
                ...
                # model.write('model_FirstModel_210924_'+str(len(I))+str('_')
                #               +str(len(L))+str('_')
                #               #+str(len(K))+str('_')
                #               #+str(len(N))+str('_')
                ...
                book.save('Tesis_FirstModel_210924_'+str(eta[0])+'_'+str(eta[1])+'.xls') 
