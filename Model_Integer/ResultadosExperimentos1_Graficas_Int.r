...
counti = 0
#for (i in len_I){
pdf(paste("Objective_FirstModel_Modified_210924_",len_L[1],'_',eta[1],'_',eta[2],".pdf", sep=""), width = 10)
...
for (a in 1:length(amb[,1])){
  ...
  aux_0 <- as.data.frame(read.csv(paste('Tesis_FirstModel_Modified_210924_',len_L[1],'_',eta[1],'_',eta[2],'.csv', sep="")))
...
counti = 0
#for (i in len_I){
pdf(paste("Objective_FirstModel_Modified_210924_",len_L[1],'_',eta[1],'_',eta[2],"_1.pdf", sep=""), width = 10)
par(mfrow = c(1, length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
for (a in 1:length(amb[,1])){
  # run time
  eta <- amb[a,]
...
#   #aux_0 <- as.data.frame(read.csv(paste('Tesis_FirstModel_Modified_210924_AllAmb.csv', sep="")))
...
counti = 0
#for (i in len_I){
pdf(paste("TimeVal_FirstModel_Modified_210924_",len_L[1],'_',eta[1],'_',eta[2],".pdf", sep=""), width = 10)
par(mfrow = c(1, length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
for (a in 1:length(amb[,1])){
  # run time
  eta <- amb[a,]
...
counti = 0
#for (i in len_I){
pdf(paste("TimeVal_FirstModel_Modified_210924_",len_L[1],'_',eta[1],'_',eta[2],"_1.pdf", sep=""), width = 10)
par(mfrow = c(1, length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
for (a in 1:length(amb[,1])){
  # run time
  eta <- amb[a,]
...
for (a in 1:length(amb[,1])){
  ...
  for (i in 1:length(len_I)){
    for (l in 1:length(len_L)){
      for (s in 1: length(len_S)){
        accidents <- suppressWarnings(as.data.frame(read.table(paste('Accidents_FirstModel_Modified_210924_', len_I[i], '_', len_L[l], '_', len_S[s], '.txt', sep=""))))
        print(paste('Accidents_FirstModel_Modified_210924_', len_I[i], '_', len_L[l], '_', len_S[s], '.txt', sep=""))
        datos <- c()
        datos <- cbind(datos, len_I[i], len_L[l], len_S[s])

        full <- as.data.frame(read.table(paste('Full_FirstModel_Modified_210924_', len_I[i], '_', len_L[l], '_', len_S[s], '_',eta[1],'_',eta[2],'.txt', sep="")))
        ...
        partial1 <- as.data.frame(read.table(paste('Partial1_FirstModel_Modified_210924_', len_I[i], '_', len_L[l], '_', len_S[s], '_',eta[1],'_',eta[2],'.txt', sep="")))
        ...
        partial2 <- as.data.frame(read.table(paste('Partial2_FirstModel_Modified_210924_', len_I[i], '_', len_L[l], '_', len_S[s], '_',eta[1],'_',eta[2],'.txt', sep="")))
        ...
        partial3 <- as.data.frame(read.table(paste('Partial3_FirstModel_Modified_210924_', len_I[i], '_', len_L[l], '_', len_S[s], '_',eta[1],'_',eta[2],'.txt', sep="")))
        ...
        null <- as.data.frame(read.table(paste('Null_FirstModel_Modified_210924_', len_I[i], '_', len_L[l], '_', len_S[s], '_',eta[1],'_',eta[2],'.txt', sep="")))
  ...
  write.csv(accidents_covered, file = paste('ExpectedCoverage_FirstModel_Modified_210924_', eta[1],'_',eta[2],'.csv', sep=""), col.names=TRUE, row.names=FALSE, dec = ".")
...
write.csv(accidents_covered_total, file = paste('ExpectedCoverageTotal_FirstModel_Modified_210924_','.csv', sep=""), col.names=TRUE, row.names=FALSE, dec = ".")
...
write.csv(prom_coverage, file = paste('MeanCoverageTotal_FirstModel_Modified_210924_','.csv', sep=""), col.names=TRUE, row.names=FALSE, dec = ".")


#coverage mean scenarios graphics
pdf(paste("Coverage_FirstModel_Modified_210924_",len_L[1],'_',eta[1],'_',eta[2],".pdf", sep=""), width = 10)
par(mfrow = c(1,  length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
for (a in 1:length(amb[,1])){
  eta = amb[a,]
...
write.csv(prom_coverage_1, file = paste('MeanCoverageTotal_FirstModel_Modified_210924_1_','.csv', sep=""), col.names=TRUE, row.names=FALSE, dec = ".")


#coverage graphics
pdf(paste("Coverage_FirstModel_Modified_210924_",len_L[1],'_',eta[1],'_',eta[2],"_1.pdf", sep=""), width = 10)
par(mfrow = c(1,  length(amb)/2), mar=c(4.5, 5, 3.1, 0.9))
for (a in 1:length(amb[,1])){
  eta = amb[a,]
  #pdf(paste("Coverage_",eta[1],"_",eta[2],".pdf", sep=""))
